  ...
  return (
    <div className={pageStyles.collectionPage} id="factory-collection">
      <div className="container">
        ...
        {featuredFactory.length > 0 && (
          <div style={{ marginBottom: "var(--space-12)" }}>
            <h2 style={{ fontSize: "1.5rem", marginBottom: "var(--space-6)", fontFamily: "var(--font-heading)" }}>Featured Factory Sets</h2>
            <div className={gridStyles.masonryGrid}>
              {featuredFactory.map((product) => (
