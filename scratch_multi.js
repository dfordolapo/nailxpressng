const url = "https://ukfwpourkksctwmdgrci.supabase.co/rest/v1/products?select=id,name&name=ilike.*multi*";
...
.then(res => res.json())
.then(data => console.log("MULTI IN NAME:", JSON.stringify(data)))
